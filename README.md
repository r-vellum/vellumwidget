...
save SVG/PNG, fullscreen) · linked views across a `group` (selection,
hover, and pan/zoom) · keyboard + screen-reader access (Tab in,
...
**1. Widget theme** — `as_widget()` arguments set the look for the whole
plot:
